...
void func() {
   ...
   int n=0;
    while (1) {  
        ...
        }else if(!strcmp("ls_l",Command)){
            execl("./ls -l","./ls -l",NULL);
            func();

        }else if(!strcmp("ls_a",Command)){
            execl("./ls -a","./ls -a",NULL);
            func();
